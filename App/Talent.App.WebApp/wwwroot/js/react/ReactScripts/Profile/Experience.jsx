            ...
            options = <React.Fragment>
                ...
                <div className='ui sixteen wide column'>
                    <div class="two fields">
                        ...
                        <button type="button" className="ui black button" onClick={this.closeAddNew}>Cancel</button>
                    </div>
                    </div>
                </div>
            </React.Fragment>
                            ...
                            <Table.Cell colSpan={6}>
                                <Grid>
                                    ...
                                    <Grid.Row>
                                        <Grid.Column>
                                            <div className="field">
                                                <button type="button" className="ui black button" onClick={this.updateExperience}>Update</button>
                    ...
                    <Table striped>
                        <Table.Header>
                            <Table.Row>
                                ...
                                <Table.HeaderCell><button type="button" className="ui right floated black button" onClick={this.showAddNew}>+ Add New</button></Table.HeaderCell>
                            </Table.Row>
                        </Table.Header>
